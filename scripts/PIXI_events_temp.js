...
function call_defineAssetLib(){
		var defineAssetLib ={
			appStageContainers : {"BG":{},
						"effects":{},
						"UI":{},
						"symbols":{},
						"graphics":{},
...
function call_defineSpriteEvent(){
                ...
                event.runApp = function(effectList, effectName,effectContainer,blendModeIndex) {
                   // console.log("blendModeIndex",blendModeIndex)
                    ...
                    app.ticker.add(function() {
                        ...
                        eventTick = tick % timeLength;
                        event.adjustAnimTransform(effectList, effectName,effectContainer, eventTick,blendMode,filter)
					   //event.adjustAnimTransform = function(effectList, effectName, effectContainer, eventTick,blendMode,filter) 
                    });
	...
	return defineSpriteEvent
};

function call_loadEffect(){
	var loadEffect = {
	effectDataTemplate: {
		"spritesImageId": "",
		"spriteImage": "",
